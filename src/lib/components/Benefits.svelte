...
<Container class="flex flex-wrap mb-20 lg:gap-10 lg:flex-nowrap ">
  <div
    class="flex items-center justify-center w-full lg:w-1/2"
    class:lg:order-1={imgPos === 'right'}
  >
    <div>
      <Image
        src={data.image}
  ...
  <div
    ...
    class:lg:justify-end={imgPos === 'right'}
  >
    <div>
