<script>
  ...
  import AmazonLogo from './logos/Amazon.svelte';
  import MicrosoftLogo from './logos/Microsoft.svelte';
  import NetflixLogo from './logos/Netflix.svelte';
  import SonyLogo from './logos/Sony.svelte';
  import VerizonLogo from './logos/Verizon.svelte';
</script>
...
<Container class="flex flex-wrap ">
  <div class="flex items-center w-full lg:w-1/2">
    <div class="max-w-2xl mb-8">
      ...
      >
        Nextly-sveltekit is a free landing page & marketing website template for startups and indie
        projects. Its built with SvelteKit & TailwindCSS. And its completely open-source.
      </p>
...
<Container>
  <div class="flex flex-col justify-center">
    ...
    <div class="flex flex-wrap justify-center gap-5 mt-10 md:justify-around">
      ...
      <div class="pt-1 text-gray-400 dark:text-gray-400">
        <NetflixLogo />
      </div>
      <div class="pt-2 text-gray-400 dark:text-gray-400">
        <SonyLogo />
